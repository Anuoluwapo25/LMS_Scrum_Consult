        ...
        <div className="w-full max-w-lg mx-auto pt-8">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-center mt-6">
            <a href="#" className="social-btn linkedin-btn">
              <img className="w-8 h-8 mr-2" src={ImgSample2} alt="LinkedIn" />
              LinkedIn
            </a>
            <a href="#" className="social-btn google-btn">
              <img className="w-8 h-8 mr-2" src={ImgSample1} alt="Google" />
              Google
            </a>
            <a href="#" className="social-btn facebook-btn">
              <img className="w-8 h-8 mr-2" src={ImgSample3} alt="Facebook" />
              Facebook
            </a>
          </div>
